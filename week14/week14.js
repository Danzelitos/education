...
// const myFirstArray = ['str', 21, true, "bar"] // объявите переменную здесь
// console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
// const mySecondArray = ['god', 'bless', 'queen' ];  // объявите переменную здесь
...
// let myInformation = ['danil', 27, 1, 1999, 'vodoley']
...
// let shiftCountries = countries.shift();
// console.log(shiftCountries, countries);
//Задание 7
