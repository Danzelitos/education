...
function makeFive() {
	...
	let attributesThree = document.forms.formThree.elements.length;
	console.log(attributesThree);
}
...
function makeSix() {
	//Ваш код
	let secondForm = document.forms.formTwo.elements;
...
function makeSeven() {
	//Ваш код
	let formElements = document.forms.formTwo.elements;
	let elementsList = [];
...
function makeEight() {
	//Ваш код
	let firstForm = document.forms[0].elements;
...
function makeNine() {
	//Ваш код
	let thiForm = document.forms[2].elements;
	for (let el of thiForm) {
...
function makeTen() {
	//Ваш код
	let checkBox = document.forms[3].elements.fourthName.value;
...
function makeEleven() {
	//Ваш код
	let selection = document.forms[0];
	// console.log(selection);
	let options = selection.elements.firstSelect;
	// console.log(options.value);
	optionsValues = '';
	for (let el of options) {
		console.log(el.value);
		optionsValues += el.value + " ,"
	}
...
function makeTwelve() {
	...
	let boxes1 = form2.elements.checkboxOne.id;
	let boxes2 = form2.elements.checkboxTwo.id;
	let boxes3 = form2.elements.checkboxThree.id;
	console.log(boxes1, boxes2, boxes3);
}
...
function checkButton(e) {
	...
	let button4 = form4.elements.fourthName;
	console.log(button4);
	if (button4.checked) {
...
function makeSixteen() {
	//Ваш код
	let form2 = document.forms[1];
	let box = form2.elements.checkboxThree;
	// console.log(box);
	box.checked = false;
	console.log(box);
}
...
const par = document.querySelector('#errorMessage');
// formOne.addEventListener('submit', function (event) {
// 	event.preventDefault(); //Отмена отправки
// 	let name = formOne.elements.firstName;
// 	//Ваш код
// 	let mail = formOne.elements.firstEmail;
...
const selectElement = document.querySelector('#firstSelect'); //Ваш код
...
const emailInput = document.forms[0].elements.firstEmail;//Ваш код
const errorMessage = document.getElementById('errorMessage');

emailInput.oninput = function () {
	//Ваш код 
	let exp = /^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i;
	if (emailInput.value.match(exp)){
		return true;
	} else {
		par.textContent = 'Error mail';
		return false;
	}
};
...
document.querySelector('.b-21').onclick = function (event) {
	...
	if (!isChecked) {
		...
		document.getElementById('result21').textContent = 'Пожалуйста, выберите хотя бы один чекбокс';
	} else {
...
document.querySelector('.b-22').onclick = function (event) {
	...
	if (nameInput.value.trim() === '') {
		//Ваш код
		event.preventDefault(); // отмена отправки формы
		document.getElementById('result22').textContent = 'Пожалуйста, заполните поле Имя';
	} else {
...
const paraf = document.querySelector('result26')
document.querySelector('.b-26').onclick = function (event) {
	event.preventDefault();
	//Ваш код
	let plHolder = document.forms[2].elements.thirdName;
	console.log(plHolder.getAttribute('placeholder'));
...
>>>>>>> 07ac384d98674c9f0a3631c50c9ddcd7dee39f37
